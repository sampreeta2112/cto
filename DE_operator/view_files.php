...
if (isset($_GET["items_details"])) {
    $cond .= "items_detail = '" . $_GET["items_details"] . "' and ";
}
if (isset($_GET["report_no"])) {
    $cond .= "report_no = '" . $_GET["report_no"] . "' and ";
}
if (isset($_GET["check_pt"])) {
    $cond .= "check_pt = '" . $_GET["check_pt"] . "' and ";
}
if (isset($_GET["location"])) {
    $cond .= "location = '" . $_GET["location"] . "' and ";
}
if (isset($_GET["from_date"]) && isset($_GET["to_date"])) {
    $cond .= "survey_date between '" . $_GET["from_date"] . "' and '" . $_GET["to_date"] . "' and ";
}
$cond = substr($cond, 0, strlen($cond) - 5);
